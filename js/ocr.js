...
const KIND_KEYWORDS = [
  ...
  /* —— 科研类：按科研经费科目命名。位置即优先级，越靠前越优先 —— */
  /* 版面费必须排在「资料图书」之前：期刊发票上常同时出现「出版服务」与「资料」，
     而版面费是明确的科目（出版/文献/信息传播费），不能被泛化的「资料」吃掉。 */
  ["版面费票据", ["版面费", "版面", "论文发表", "发表费", "审稿费", "稿件处理", "彩页费", "出版费",
    "编辑费", "排版费", "apc", "article processing", "publication"]],
  ["专利费票据", ["专利费", "专利申请", "专利代理", "代理费", "专利年费", "年费", "维持费",
    "知识产权", "商标注册", "软著登记", "patent"]],
  /* 外协：委托开发 / 委托测试 / 合作研究。「委托加工」与「加工服务」分属外协与软件服务，
     故这里只收带「委托 / 外协 / 外包 / 合作」的写法。 */
  ["外协服务票据", ["外协", "外协费", "委托开发", "委托测试", "委托研究", "委托加工", "委托业务",
    "合作开发", "合作研究", "联合开发", "技术开发", "技术外包", "外包服务", "协作费", "outsourcing"]],
  ["测试化验加工票据", ["测试化验", "化验加工", "检测服务", "检测费", "化验费", "测试服务", "试验费",
    "打样", "机加工", "加工费", "样品检测", "第三方检测", "testing"]],
  /* 仪器设备：用具体仪器名而非泛化的「设备」，否则会与竞赛的「设备器材」争抢 */
  ["仪器设备票据", ["仪器设备", "实验仪器", "科研仪器", "测试仪器", "分析仪器", "实验设备", "科研设备",
    "实验室设备", "示波器", "显微镜", "光谱仪", "离心机", "恒温箱", "干燥箱", "电子天平", "试验机"]],
  ...
  /* 耗材材料：走「材料 / 试剂」等科研说法；泛化的「耗材」仍归器件耗材，
     在科研场景下再由 sanitizeReceiptKind 收敛到本类，避免两条规则同时抢一个词。 */
  ["耗材材料票据", ["实验材料", "化学试剂", "试剂", "材料费", "原材料", "玻璃器皿", "标准物质",
    "生物试剂", "气体", "实验用品", "易耗品", "耗材材料", "reagent"]],
  ["资料图书票据", ["图书", "书籍", "教材", "报刊", "资料费", "印刷", "打印", "装订", "复印", "文印", "资料"]],
  ["软件服务票据", ["软件", "授权", "license", "云服务", "云主机", "服务器", "域名", "会员", "订阅", "技术服务",
    "信息服务", "加工服务", "设计服务", "软件服务", "software", "saas"]],
  /* 「咨询」与「评审」刻意拆开：科研科目里是专家咨询费，竞赛场景里是专家评审费，
     两类词若混在一处，命中数相同的发票会随机落到其中一类。 */
  ["专家咨询费", ["专家咨询", "咨询费", "咨询", "论证费", "鉴定费", "劳务费", "顾问费", "consulting"]],
  ["竞赛报名费", ["报名费", "参赛费", "竞赛报名", "赛事服务", "参赛报名"]],
  ["专家评审费", ["评审费", "评审专家", "专家费", "答辩费"]],
